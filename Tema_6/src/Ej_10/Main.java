...
public class Main {
	...
	public static boolean hasGanado(int[][] juego,int juegos) {
		boolean acaba=false;
		if(juegos<=8) {
		if(juego[0][0]==juego[0][1]&&juego[0][1]==juego[0][2]&&juego[0][0]!=0&&juego[0][1]!=0&&juego[0][2]!=0) {
			if(juego[0][0]==1) {
		...
		if(juego[1][0]==juego[1][1]&&juego[1][1]==juego[1][2]&&juego[1][0]!=0&&juego[1][1]!=0&&juego[1][2]!=0) {
			if(juego[1][0]==1) {
				System.out.println("Gana el jugador 1");
				acaba=true;
				return acaba;
		...
		}if(juego[2][0]==juego[2][1]&&juego[2][1]==juego[2][2]&&juego[2][0]!=0&&juego[2][1]!=0&&juego[2][2]!=0) {
			if(juego[2][0]==1) {
				System.out.println("Gana el jugador 1");
				acaba=true;
				return acaba;
		...
		if(juego[0][0]==juego[1][0]&&juego[1][0]==juego[2][0]&&juego[0][0]!=0&&juego[1][0]!=0&&juego[2][0]!=0) {
			if(juego[0][0]==1) {
				System.out.println("Gana el jugador 1");
				acaba=true;
				return acaba;
		...
		}if(juego[0][1]==juego[1][1]&&juego[1][1]==juego[2][1]&&juego[0][1]!=0&&juego[1][1]!=0&&juego[2][1]!=0) {
			if(juego[0][1]==1) {
				System.out.println("Gana el jugador 1");
				acaba=true;
				return acaba;
		...
		}if(juego[0][2]==juego[1][2]&&juego[1][2]==juego[2][2]&&juego[0][2]!=0&&juego[1][2]!=0&&juego[2][2]!=0) {
			if(juego[0][2]==1) {
				System.out.println("Gana el jugador 1");
				acaba=true;
				return acaba;
		...
		if(juego[0][0]==juego[1][1]&&juego[1][1]==juego[2][2]&&juego[0][0]!=0&&juego[1][1]!=0&&juego[2][2]!=0) {
			if(juego[0][0]==1) {
				System.out.println("Gana el jugador 1");
				acaba=true;
				return acaba;
		...
		}if(juego[0][2]==juego[1][1]&&juego[1][1]==juego[2][0]&&juego[0][2]!=0&&juego[1][1]!=0&&juego[2][0]!=0) {
			if(juego[0][2]==1) {
				System.out.println("Gana el jugador 1");
				acaba=true;
				return acaba;
